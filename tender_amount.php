...
<div class="container-fluid">
    ...
    <div class="w-100 d-flex justify-content-end mt-2">
            <button class="btn btn-sm btn-primary me-2 rounded-0" type="button" id="save_trans" onclick="function3()" >Save</button>
...
function function3() { 
	swal("Success!", "Your Transaction have been saved. Thank you!", "success");
}
function function4() { 
