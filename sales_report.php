    ...
    <div class="card-body">
        ...
        <table class="table table-hover table-striped table-bordered">
            ...
            <tbody>
                ...
                $total_sales_qry = $conn->query("SELECT SUM(total) as total_sales FROM `transaction_list` WHERE date(date_added) BETWEEN '{$dfrom}' AND '{$dto}' {$user_where}");
                $total_sales = $total_sales_qry->fetch_assoc()['total_sales'];
            ...
            <tfoot>
                <tr>
                    ...
                    <th class="text-end"><?php echo format_num($total_sales); ?></th>
                    <th></th>
                </tr>
            </tfoot>
        </table>
